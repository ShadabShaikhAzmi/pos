    ...
    public function run()
    {
        ...
        if (!DB::table('general_settings')->count()) {
            DB::table('general_settings')->insert([
                [
                    'id' => 1,
                    'site_title' => !empty(self::$tenantData) ? self::$tenantData['site_title'] : 'POS',
                    'site_logo' => !empty(self::$tenantData) ? self::$tenantData['site_logo'] : 'logo.png',
                    'is_rtl' => 0,
                    'currency' => '1',
                    ...
                    'without_stock' => 'no',
                    'date_format' => 'd/m/Y',
                    'developed_by' => !empty(self::$tenantData) ? self::$tenantData['developed_by'] : 'Bhiwandi Lions',
