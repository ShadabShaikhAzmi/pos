@php
    $layout = config('database.connections.pos') ? 'landlord.layout.main' : 'backend.layout.main';
@endphp
        ...
        <section id="newVersionSection" class="container text-center">
            <div class="card">
                <div class="card-body">
                    ...
                    <p><a target="_blank" href="{{ config('database.connections.pos') ? 'https://lion-coders.com/software/salepro-saas-pos-inventory-saas-php-script' : 'https://lion-coders.com/software/salepro-inventory-management-system-with-pos-hrm-accounting' }}">Change Log</a></p>
                </div>
            </div>
            ...
            <form action="{{ config('database.connections.pos') ? route('saas-version-upgrade') : route('version-upgrade') }}" method="post">
                @csrf
