...
trait FileHandleTrait{
    ...
    {
        // if ($fileName && !config('database.connections.pos') && File::exists(public_path().$filePath.$fileName))
        //    File::delete(public_path().$filePath.$fileName);
        // else if($fileName && File::exists($filePath.$fileName))
        //    File::delete($filePath.$fileName);


        if($fileName && !config('database.connections.pos') && file_exists('public/'.$filePath.$fileName))
